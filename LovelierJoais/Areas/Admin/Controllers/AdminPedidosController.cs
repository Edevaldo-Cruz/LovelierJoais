...
namespace LovelierJoais.Areas.Admin.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,PedidoEnviado,PedidoEntregueEm")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PedidoId,PedidoEnviado,PedidoEntregueEm")] Pedido pedido)
        {
